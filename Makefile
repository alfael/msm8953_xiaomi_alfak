...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   := -Wall -Wno-error=memset-elt-size -Wno-error=maybe-uninitialized -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -std=gnu89 -pipe
HOSTCXXFLAGS = -O3
...
KBUILD_CFLAGS   := -O3 -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -pipe \
